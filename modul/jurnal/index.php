<script type="text/javascript" src="modul/jurnal/ajax.js"></script>
<style type="text/css">
...
echo "<div id=\"form_input\">
	...
	<tr>
		<td>&nbsp;</td>
		<td><a href=\"#\" title='Simpan' id='simpan' class=\"easyui-linkbutton\" data-options=\"plain:true,iconCls:'icon-save'\"></a>
		<a href=\"#\" title='New' id='new' class=\"easyui-linkbutton\" data-options=\"plain:true,iconCls:'icon-new'\"></a>		
		<!--<button type='button' id='simpan' class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-add'\">Simpan</button>
		<button type='button' id='new' class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-new'\">Baru</button> --></td>
	</tr>
	</table>
...
echo "</div>";
echo "<div id=\"form_cari_akun\" class=\"easyui-dialog\" title=\"Cari Data Akun \" style=\"padding:5px;width:800px;height:480px;\"
