...
$(document).ready(function(){
	...
	function cariRekening(){
		...
		$.ajax({
			type	: "POST",
			url		: "modul/penerimaan_kas/cari_rekening.php",
			data	: "kode="+kode,
			dataType : "json",				  
	...
	$("#cariAkun").click(function(){
			$('#form_cari_akun').load('modul/penerimaan_kas/cari_jurnal/index.php');
	...
	*/
	...
	$(".data").flexigrid({
		  url : 'modul/penerimaan_kas/post-json.php',	//Mengambil data yang akan ditampilkan pada grid dengan format JSON
		  dataType : 'json',
	  ...
	  function test(com, grid) {
		  if (com == 'Delete') {
			  ...
			  window.location.replace('media.php?module=penerimaan_kas');
		  }
	  }
	...
	function CariNomor(){
		...
		$.ajax({
			type	: "POST",
			url		: "modul/penerimaan_kas/cari_nomor.php",
			data	: "id="+id,
			dataType : "json",				  
			success	: function(data){
				$("#kode").val(data.kode);
	...
	function EditData(e){
		...
		$.ajax({
			type	: "POST",
			url		: "modul/penerimaan_kas/cari.php",
			data	: "id="+id,
			dataType : "json",				  
			success	: function(data){
				$("#kode").val(id);
	...
	function HapusData(e){
		...
		$.ajax({
			type	: "POST",
			url		: "modul/penerimaan_kas/hapus.php",
			data	: "id="+id,			  
			success	: function(data){
				$.messager.show({
					title:'Info',
	...
	function simpan(){
		...
		*/
		$.ajax({
			type	: "POST",
			url		: "modul/penerimaan_kas/simpan.php",
