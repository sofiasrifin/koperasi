...
<script type="text/JavaScript">
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_sms_notification.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
<body onLoad="MM_preloadImages('images/deleteall_over.gif')">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <!--DWLayoutTable-->
    <tr>
      <td width="74%" height="41" valign="middle"><a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'tambah_sound.php', 'Tambah Sound', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('pelanggan','','images/tambah_sound_over.gif',1)"><img src="images/tambah_sound.gif" name="pelanggan" height="25" border="0" id="pelanggan" /></a></td>
      <td width="26%" align="right" valign="middle">
<?php
$stat=mysql_query("select sound from seting");
$tstat=mysql_fetch_array($stat);
if($tstat[sound]==1)
{
$status="aktif";
$nilai=0;
...
echo"<a class='baca'>Status sound <strong><a class='baca' href='insert.php?id=stat_sound&nilai=$nilai'>$status</strong></a></a>";
...
if($note==play)
{
$sound=mysql_query("SELECT * FROM sound where id='$no'");
