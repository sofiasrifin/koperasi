...
?>
<a href="#<?=$hp;?>" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'edit_daftar.php?group=<?=$row2[grup];?>&berhasil=<?=$row2[reg_berhasil];?>&ada=<?=$row2[reg_ada];?>', 'Rubah Autorespond Daftar', 'width=360px,height=350px,center=1,resize=0,scrolling=0', 'recal')">
<?	
	echo"edit</a></td></tr>";
$o++;
}
