...
<body onLoad="MM_preloadImages('images/deleteall_over.gif')"><form action="del.php" method="post" name="tambah" id="tambah">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      </a><img src="images/garis.gif" /> <a href="del.php?id=delete_all" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image34','','images/deleteall_over.gif',1)"><img src="images/deleteall.gif" name="Image34" width="100" height="25" border="0" id="Image34" onClick="return confirm('Apakah anda yakin akan menghapus semua SMS terkirim ini?\n\'Cancel\' untuk membatalkan, \'OK\' untuk menghapus.')" /></a> <img src="images/garis.gif" /> <a href="export.php?id=outbox" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('pelanggan','','images/export_sms_over.gif',1)"><img src="images/export_sms.gif" name="pelanggan" height="25" border="0" id="pelanggan" /></a></td>
    </tr>
    <tr>
      <td height="26"><?php
/* PagingWeb.php */
...
$sql2 = "SELECT * FROM sentitems ORDER BY ID DESC LIMIT $tcon[sentitem]";
...
?>
<a href="#<?php echo $hp;?>" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'ok.php?no_hp=<?php echo $hp1;?>&phoneid=<?php echo $row2[SenderID];?>', 'Balas SMS', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')">
...
if($jml2==0)
{
   ...
   echo "<tr class='baca1'>
    <th  width='4%' align='left'></th>
    <th width='30%' align='left'>Nomor Tujuan</th>
    <th width='45%' align='left'>Isi Pesan</th>
    <th width='20%' align='left'>Status</th>
    <th width='10%' align='left'></th>
