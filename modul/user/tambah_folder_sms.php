  ...
  <div style="padding: 5px">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="baca1">
      ...
      <tr valign="middle">
        ...
        <td valign="bottom" bgcolor="#FFFFFF" class="style1">Silahkan masukkan nama Folder </td>
      </tr>
      <tr valign="middle">
      ...
      <tr valign="middle">
        ...
        <td width="88%" bgcolor="#FFFFFF"><input name="nama" type="text" class="baca1" id="nama" size="30" />
        <input name="id" type="hidden" id="id" value="tambah_folder_sms" /></td>
      </tr>
      <tr>
