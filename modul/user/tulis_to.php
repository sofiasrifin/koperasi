  ...
  <td><table id="ctTBL" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        ...
        <td width="76%" valign="top" id="mainTD"><form action="kir_to.php?id=kotak_masuk" method="post" name="ddmessage" id="ddmessage">
          <table width="670" border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="86%" height="395" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="24" valign="middle" bgcolor="#EEEEEE" class="baca1"><span class="badan">&nbsp;&nbsp;Try Out Ke  <span class="style1">
                  ...
                  <tr>
                    <td height="189" valign="top" class="baca1"><span class="MsoNormal">
                      <select name="try_out" class="bacas" id="try_out">
                        <option selected="selected">-- Silahkan Pilih --</option>
                        <? $sql1=mysql_query("SELECT distinct try_out from nilai_siswa");
while ($a1=mysql_fetch_array($sql1))
{
?>
                        <option> <? echo"$a1[try_out]";
}
?></option>
                      </select>
                    </span></td>
                    <td height="189" valign="top" class="baca1">&nbsp;</td>
                    <td height="189" valign="top" class="baca1"><span class="tulisan"><?php echo service3(''); ?></span></td>
                  </tr>
                  <tr>
                    ...
                    <td width="35%" valign="middle" bgcolor="#EEEEEE" class="baca1"><span class="badan">&nbsp;&nbsp;&nbsp;Keterangan</span></td>
                  </tr>
                  <tr>
                    ...
                    <td valign="top" class="baca1"><p class="MsoNormal">
                        <select name="selectbox" class="bacas" onChange="changecontent(this)">
                          <option selected="selected">-- Silahkan Pilih --</option>
                          <? $sql=mysql_query("SELECT judul from template_sms");
