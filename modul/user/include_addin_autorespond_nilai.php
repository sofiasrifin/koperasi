...
<script type="text/JavaScript">
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_nohp1.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="41" valign="middle"><a onload="MM_preloadImages('images/delete_over.gif')"> <a onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('hapus','','images/delete_over.gif',1)">
        <input name="Submit" type="image" value="Submit" src="images/delete.gif" name="hapus" width="70" height="25" border="0" id="hapus" onclick="return confirm('Apakah anda yakin akan menghapus Data Nilai ini?\n\'Cancel\' untuk membatalkan, \'OK\' untuk menghapus.')">
      </a> <img src="images/garis.gif" /> <a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'tambah_nilai.php', 'Tambah No HP', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('pelanggan','','images/nilai_over.gif',1)"><img src="images/nilai.gif" name="pelanggan" height="25" border="0" id="pelanggan" /></a></td>
...
$sql2 = "SELECT * FROM nilai_siswa ORDER BY id DESC";
...
if ($jml2<>0)
{
   ...
   echo "<tr class='baca1'>
    ...
    <th width='25%' align='left'>NIS</th>
    <th width='20%' align='left'>Big</th>
    <th width='20%' align='left'>Bin</th>
    <th width='20%' align='left'>Mat</th>
    <th width='20%' align='left'>Ipa</th>
...
echo "<tr class='row0'>
    <td class='baca1' align='left'> <input type='checkbox' name='chk[$o]' value='$row2[id]'>"; ?>
        <? echo"</a></td>";    
echo "<td class='baca1' align='left'>$row2[nis]</td>
    <td class='baca1' align='left'>$row2[big]</td>
    <td class='baca1' align='left'>$row2[bin]</td>
    <td class='baca1' align='left'>$row2[mat]</td>
    <td class='baca1' align='left'>$row2[ipa]</td>";
echo"
