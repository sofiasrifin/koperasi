...
<script type="text/JavaScript">
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_daftar.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
$sql2 = "SELECT * FROM daftar_nohp ORDER BY id DESC";
...
echo "<td class='baca1' align='left'>$row2[grup]</td>
    <td class='baca1' align='left'>$row2[reg_berhasil]</td>
    <td class='baca1' align='left'>$row2[reg_ada]</td>
    <td class='baca1' align='left'>";
?>
<a href="#<?php echo $hp;?>" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'edit_daftar.php?group=<?php echo $row2[grup];?>&berhasil=<?php echo $row2[reg_berhasil];?>&ada=<?php echo $row2[reg_ada];?>', 'Rubah Autorespond Daftar', 'width=360px,height=350px,center=1,resize=0,scrolling=0', 'recal')">
<?php	
	echo"edit</a></td></tr>";
$o++;
}
