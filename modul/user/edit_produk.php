          ...
          <tr>
            ...
            <td width="71%" valign="top" bgcolor="#FFFFFF"><form action="insert.php" method="post" name="account" id="account" onSubmit="MM_validateForm('password','','R','nama','','R','alamat','','R');return document.MM_returnValue">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="baca1">
                ...
                <tr>
                  <td height="25" colspan="3" align="center" bgcolor="#EFEFDE"><strong>Tambah Produk</strong></td>
                </tr>
                <tr>
                  <td width="2%" height="25" bgcolor="#FFFFFF">&nbsp;</td>
                  <td width="20%" align="right" bgcolor="#FFFFFF">&nbsp;</td>
                  <td width="78%" bgcolor="#FFFFFF"><input name="id" type="hidden" id="id" value="update_produk" />
				  <?
				  $produk=mysql_query("SELECT * FROM data_produk WHERE id='$id'");
                ...
                <tr>
                  ...
                  <td align="right" bgcolor="#FFFFFF">Nama Produk: </td>
                  <td bgcolor="#FFFFFF">&nbsp;
                      <input name="nama" type="text" class="baca1" id="nama" value="<?=$run[nama_produk];?>" size="40" /></td>
                </tr>
                <tr>
                  <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
                  <td align="right" bgcolor="#FFFFFF"> Harga   : </td>
                  <td bgcolor="#FFFFFF">&nbsp;
                      <input name="harga" type="text" class="baca1" id="harga" value="<?=$run[harga];?>" size="40" /></td>
                </tr>
              ...
              <p><strong class="baca"> <br>
              Note :</strong></p>
              <ul>
                <li><span class="baca">Nama produk nanti digunakan untuk menentukan format sms. Semisal nama produk itik maka format sms <strong>&quot;telur&lt;spasi&gt;itik&quot; </strong></span></li>
                <li><span class="baca">Harga tidak hanya berupa angka namun bisa berupa huruf. Semisal <strong>&quot;Rp. 4000/kg </strong></span><strong>&quot;</strong><br>
                  </li>
              </ul>
            </form></td>
          </tr>
