...
<body>
<form action="../process_update.php" method="post" name="form1" id="form1">
  <div style="padding: 5px">
    <p class="style1">Silahkan pilih file update </p>
    <p class="style1">&nbsp;</p>
...
- Nama file update tidak boleh dirubah </span></div>
</form>
</body>
</html>
