...
$pesan = "$Text";
$query = mysql_query("INSERT INTO outbox (DestinationNumber, TextDecoded, ID, MultiPart, SenderID, CreatorID) VALUES ('$no_hp', '$pesan', '$newID', 'true', '$phoneid', 'Gammu')");
echo"SMS anda sedang dikirim ke nomer <b>$no_hp</b>. Silahkan cek laporan pengiriman untuk status pengiriman";
?>&nbsp;</td>
