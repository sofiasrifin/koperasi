...
<table width="860" height="701" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
		...
		<td colspan="5" rowspan="2" valign="top" background="images/ground.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left"><form action="update_user.php" method="post" enctype="multipart/form-data" name="account" id="account">
	...
	?></td>
                        ...
                        <tr>
                          <td height="25" colspan="3" align="center" bgcolor="#EFEFDE"><strong>Ganti Foto Kamu  </strong></td>
                        </tr>
                        <tr>
                          <td height="25" bgcolor="#FFFFFF">&nbsp;</td>
                          <td width="20%" align="right" bgcolor="#FFFFFF">&nbsp;</td>
                          <td width="78%" bgcolor="#FFFFFF"><input name="id" type="hidden" id="id" value="update_foto" />
                              <input name="no" type="hidden" id="no" value="<?=$tampil[no];?>" />
                              <input name="hide" type="hidden" id="hide" value="<?=$tampil[nama];?>">
                          <input name="foto" type="hidden" id="foto" value="<?=$tampil[foto];?>" /></td>
                        </tr>

                        <tr>
                          <td height="31" bgcolor="#FFFFFF">&nbsp;</td>
                          <td align="right" bgcolor="#FFFFFF">Foto :</td>
                          <td bgcolor="#FFFFFF">&nbsp;
