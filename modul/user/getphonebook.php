...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="94%"><table width="50%" border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td nowrap="nowrap"><select name="_num_dump[]" size="10" multiple="multiple" id="_num_dump[]" ondblclick="moveSelectedOptions(this.form['p_num_dump[]'],this.form['p_num[]'])">
...
?></option>
        ...
        <td align="center" valign="middle" class="baca1"><input name="button2" type="button" class="button" onclick="moveSelectedOptions(this.form['p_num_dump[]'],this.form['p_num[]'])" value="&gt;&gt;" />
              ...
              <br />
              <br />
              <input name="button2" type="button" class="button" onclick="moveAllOptions(this.form['p_num[]'],this.form['p_num_dump[]'])" value="All &lt;&lt;" />        </td>
        <td width="10">&nbsp;</td>
