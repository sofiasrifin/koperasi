...
<script type="text/JavaScript">
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_account.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="41" valign="middle"><a onload="MM_preloadImages('images/delete_over.gif')"> <a onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('hapus','','images/delete_over.gif',1)">
        <input name="Submit" type="image" value="Submit" src="images/delete.gif" name="hapus" width="70" height="25" border="0" id="hapus" onclick="return confirm('Apakah anda yakin akan menghapus Data Account ini?\n\'Cancel\' untuk membatalkan, \'OK\' untuk menghapus.')">
      </a> <img src="images/garis.gif" /> <a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'tambah_user.php', 'Tambah User', 'width=330px,height=320px,center=1,resize=0,scrolling=0', 'recal')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('pelanggan','','images/tambah_user_over.gif',1)"><img src="images/tambah_user.gif" name="pelanggan" height="25" border="0" id="pelanggan" /></a></td>
