   ...
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_header_footer.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
<a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'ganti_header_footer.php?id=<?php echo $row2[Id];?>', 'Ganti Header Footer SMS', 'width=330px,height=330px,center=1,resize=0,scrolling=0', 'recal')">
