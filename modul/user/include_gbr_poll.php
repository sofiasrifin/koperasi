...
<script type="text/javascript">
			...
			function cekinbox()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_gbr_poll.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
<td class='baca1' align='left'>
<a href='include_gambar_poll.php?id_poll=<?php echo $row2[id_poll];?>'><img src="images/plus.gif" border="0" title="graphic polling"/></a> 
</td>
