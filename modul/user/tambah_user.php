...
<form name="form1" method="post" action="update_user.php">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="baca1">
    <tr>
      <td width="2%" height="34" bgcolor="#FFFFFF">&nbsp;</td>
      <td colspan="2" align="left" bgcolor="#FFFFFF"><strong>
        
      </strong>        Silahkan masukkan data pada form dibawah ini
      <input name="id" type="hidden" id="id" value="user" /></td>
    </tr>
    <tr>
      <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="17%" align="left" bgcolor="#FFFFFF">Password </td>
      <td width="81%" bgcolor="#FFFFFF">&nbsp;:
        <input name="pass" type="password" class="baca1" id="pass" size="25" /></td>
    </tr>
    <tr>
      <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="left" bgcolor="#FFFFFF">User ID </td>
      <td bgcolor="#FFFFFF">&nbsp;:
      <input name="user_id" type="text" class="baca1" id="user_id" size="25" /></td>
    </tr>
    <tr>
      <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="left" bgcolor="#FFFFFF">Nama </td>
      <td bgcolor="#FFFFFF">&nbsp;:
        <input name="nama" type="text" class="baca1" id="nama" size="25" /></td>
    </tr>
    <tr>
      <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF">&nbsp;:
        <input name="alamat" type="text" class="baca1" id="alamat" size="25" />      </td>
    </tr>
    <tr>
      <td height="31" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="left" bgcolor="#FFFFFF">Telp / HP </td>
      <td bgcolor="#FFFFFF">&nbsp;:
        <input name="telp_hp" type="text" class="baca1" id="telp_hp" size="25" /></td>
    </tr>
    <tr>
      <td height="31" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="left" bgcolor="#FFFFFF">E-Mail </td>
      <td bgcolor="#FFFFFF">&nbsp;:
        <input name="email" type="text" class="baca1" id="email" size="25" /></td>
    </tr>
    <tr>
      <td height="16" align="left" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="16" align="left" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="16" align="left" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr>
