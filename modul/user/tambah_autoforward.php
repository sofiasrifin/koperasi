...
<body>
<form action="insert_grup_autoforward.php" method="post" name="ddmessage" id="ddmessage">
  <div style="padding: 5px">
    <p class="style1">Silahkan pindahkan data No HP ke sebelah kanan</p>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="style1">

      <tr>
        <td height="27" bgcolor="#FFFFFF"><table width="50%" border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td nowrap="nowrap"><select name="p_num_dump[]" size="10" multiple="multiple" ondblclick="moveSelectedOptions(this.form['p_num_dump[]'],this.form['p_num[]'])">
                <?php $sql=mysql_query("SELECT nama,no_hp from data_pelanggan order by nama asc");
...
?></option>
      ...
      <tr>
        <td height="27" bgcolor="#FFFFFF">Nama Group&nbsp;</td>
      </tr>
      <tr>
        <td height="27" bgcolor="#FFFFFF"><input name="grup" type="text" id="grup" size="40" /></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="37" align="center" valign="middle" bgcolor="#EFEFDE"><a onload="MM_preloadImages('images/kirim_over.gif')"> <a onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('kirim','','images/kirim_over.gif',1)">
          <input name="Submit" type="image" value="Submit" src="images/kirim.gif" width="70" height="25" border="0" id="kirim" onClick="selectAllOptions(this.form['p_num[]'])" "parent.agreewin.hide()"/>
        </a></a></td>
      </tr>
    </table>
  </div>
