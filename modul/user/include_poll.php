...
<script type="text/javascript">
			...
			function cekinbox()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_poll.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
<td class='baca1' align='left'>$tket[ket_poll] </td>
	...
	?>
<a href='#' onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'hasil_polling.php?id_poll=<?php echo "$row2[id_poll]";?>', 'Hasil Polling', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')"><img src="images/passbook.png" border="0" title="hasil polling"/></a> &nbsp;<a href='del.php?id=poll&id_poll=<?php echo "$row2[id_poll]";?>' onclick="return confirm('Apakah anda yakin akan menghapus data poling ini?\n\'Cancel\' untuk membatalkan, \'OK\' untuk menghapus.')"><img src="images/del.gif" border="0" title="hapus polling"/></a>
