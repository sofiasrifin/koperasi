...
<p class="kiri">Tambahkan no HP. No HP yang terdaftar akan di izinkan untuk menggunakan fasilitas autoforward 
<form id="form1" name="form1" method="post" action="insert.php">
  <input name="no_hp" type="text" class="warkecil" id="no_hp" size="30" />
  <input name="Submit" type="submit" class="baca" value="tambah" />
  <input name="id" type="hidden" id="id" value="nohp_autoforward" />
</form>
<p>
...
$sql2 = "SELECT * FROM nohp_autoforward";
...
echo "<td class='baca1' align='left'>$row2[no_hp]</td>";
...
?> <a href="compose.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('compose','','images/compose_over.gif',1)">
        <input name="id" type="hidden" id="id" value="allowed_autoforward" />
          </a></td>
    </tr>
  </table>
</form>
