...
<script type="text/JavaScript">
			...
			function ceknohp()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_seting_autorespond.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
...
<form action="del.php" method="post" name="data_pelanggan" id="data_pelanggan">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      </a> <img src="images/garis.gif" /> <a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'tambah_autorespond.php', 'Tambah Autorespond', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('pelanggan','','images/autorespond_over.gif',1)"><img src="images/autorespond.gif" name="pelanggan" height="25" border="0" id="pelanggan" /></a></td>
