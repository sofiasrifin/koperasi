...
<script type="text/JavaScript">
			...
			function cektemplate()
			{
				...
				if ($http) {
					...
					$http.open('GET', 'cek_template.php' + '?' + new Date().getTime(), true);
					$http.send(null);
				}
              ...
              <form action="del.php" method="post" name="tambah" id="tambah">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    </a> <img src="images/garis.gif"> <a href="#" onClick="agreewin=dhtmlmodal.open('agreebox', 'iframe', 'tambah_template.php', 'Tambah Template SMS', 'width=330px,height=280px,center=1,resize=0,scrolling=0', 'recal')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('produk','','images/tambah_template_over.gif',1)"><img src="images/tambah_template.gif" name="produk" width="120" height="25" border="0"></a>
