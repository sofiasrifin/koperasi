var notepad={
	padHTML:'<div class="notepad"><span class="close" title="Close Notepad">X</span><h3 class="title"></h3>'
				+'<p><? echo"ok"; ?>Silahkan masukkan pesan balasan yang ingin dikirimkan.</p>'
				+'<form id="form1" name="form1" method="post" action="cobawae.php"><input name="no_hp" type="text" id="no_hp" value="<?=$id;?>">'
