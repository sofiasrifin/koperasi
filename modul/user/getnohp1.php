...
$sql2 = "SELECT * FROM data_pelanggan WHERE no_hp like '%$hp%' ORDER BY id DESC LIMIT $tcon[phonebook]";
...
echo "<tr class='row0'>
    ...
    <td class='normal'align='left'><a class='baca1'>Maaf tidak ada no HP dengan no <b>$q2</b></a></td>
