...
<form action="insert.php" method="post" name="form1" id="form1">
  <div style="padding: 5px">
    <p class="style1">Silahkan tambahkan Autorespond </p>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="style1">

      <tr>
        <td width="17%" bgcolor="#FFFFFF">Keyword</td>
        <td width="2%" height="27" bgcolor="#FFFFFF"> : </td>
        <td width="81%" bgcolor="#FFFFFF">&nbsp;
            <input name="kunci" type="text" class="baca1" id="kunci" size="30" />
            <input name="id" type="hidden" id="id" value="autorespond" /></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">Isi SMS </td>
        <td height="27" bgcolor="#FFFFFF">  : </td>
        <td bgcolor="#FFFFFF">&nbsp;
          <textarea name="isi_sms" cols="24" id="isi_sms"></textarea></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">Aktif</td>
        <td height="27" bgcolor="#FFFFFF"> : </td>
        <td bgcolor="#FFFFFF">&nbsp;
