...
<form action="insert.php" method="post" name="form1" id="form1">
  <div style="padding: 5px">
    <p class="style1">Silahkan rubah isi SMS balasan </p>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="style1">
      <tr>
        <td width="20%" bgcolor="#FFFFFF">Isi SMS  </td>
        <td width="2%" height="27" bgcolor="#FFFFFF"> : </td>
        <td width="78%" bgcolor="#FFFFFF">&nbsp;
            <textarea name="isi_sms" cols="25" rows="5" class="baca1" id="isi_sms"><?=$isi_sms;?>
            </textarea>
            <input name="id" type="hidden" id="id" value="update_format_salah" /></td>
      </tr>
      <tr>
