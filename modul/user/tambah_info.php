...
<form action="insert.php" method="post" name="form1" id="form1">
  <div style="padding: 5px">
    <p class="style1">Silahkan tambahkan info ruangan baru. </p>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="style1">
      ...
      <tr>
        ...
        <td width="76%" bgcolor="#FFFFFF"><input name="ruang" type="text" class="baca1" id="ruang" size="35" onblur="javascript:doRequest('get','info_ruangan.php?kode='+this.value,'text','inforesult')"/>
            <input name="id" type="hidden" id="id" value="info_ruang" /></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td height="27" bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF"><div id="inforesult" style="margin: 2px 0pt 10px;"></div></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">Ket Ruang </td>
        <td height="27" bgcolor="#FFFFFF">  : </td>
        <td bgcolor="#FFFFFF"><textarea name="ket" cols="27" rows="4" id="ket"></textarea></td>
      </tr>
      <tr>
