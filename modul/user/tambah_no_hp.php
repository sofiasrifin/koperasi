    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="style1">
      ...
      <tr>
        ...
        <td width="81%" bgcolor="#FFFFFF">&nbsp;
            <input name="namapengguna" type="text" class="baca1" id="namapengguna" size="30" />
        <input name="id" type="hidden" id="id" value="tambah_pelanggan" /></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">No HP</td>
        <td height="27" bgcolor="#FFFFFF">  : </td>
        <td bgcolor="#FFFFFF">&nbsp;
            <input name="no_hp" type="text" class="baca1" id="no_hp" size="30" /></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">Alamat</td>
        <td height="27" bgcolor="#FFFFFF"> : </td>
        <td bgcolor="#FFFFFF">&nbsp;
            <input name="alamat" type="text" class="baca1" id="alamat" size="30" />        </td>
      </tr>
      <tr>
