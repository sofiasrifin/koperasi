...
{
?>
<td class='baca1' align='left'><a name='<?=$hp;?>' href='#' alt='<?=$row2[SenderNumber];?>'><?=$tampilkan[nama];?></a></td>
<?
}
if ($hasil==0)
{
...
<a href="#<?=$row2[SenderNumber];?>" onClick="dhtmlmodal.open('EmailBox', 'iframe', 'ok.php?no_hp=<?=$hp;?>', 'Balas SMS', 'width=350px,height=280px,center=1,resize=0,scrolling=0')">
<?
...
?> 
<script type="text/javascript">
function openbukutelepon(){

agreewin=dhtmlmodal.open("agreebox", "iframe", "tambah_buku_telepon.php?no_hp=<?=$hp;?>", "This Page's Terms of service", "width=590px,height=450px,center=1,resize=1,scrolling=0", "recal")
...
<a href="#" onClick="openbukutelepon(); return false">
