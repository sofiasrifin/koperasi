...
$(document).ready(function(){
	...
	function lihat(e){
		...
		$.ajax({
			type	: "GET",
			url		: "modul/lap_jual/tampil_data.php",
			data	: "tgl1="+tgl1+"&tgl2="+tgl2+"&field="+field+"&text="+text+"&urut="+urut+"&pilih="+pilih+"&page="+e,
			success	: function(data){
				$("#tampil_data").html(data);
				$("#paging_button").load("modul/lap_jual/paging.php?tgl1="+tgl1+"&tgl2="+tgl2+
	...
	$("#cetak").click(function(){
		...
		window.open("modul/laporan/lap-jual.php?tgl1="+tgl1+"&tgl2="+tgl2+
