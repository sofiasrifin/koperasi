...
$text = "select sum(jmljual) as jml, a.tgljual,b.kode_barang
		from h_jual as a
		join d_jual as b
		on a.kodejual=b.kodejual
		$where
		group by a.tgljual,b.kode_barang";
$pmb = mysql_query($text) or die(mysql_error());
//echo $text;
...
echo "<tr bgcolor=\"#D5F35B\"> 
	<td>$row_pmb[kode_barang]</td> 
	<td align=\"center\">".number_format($jml)."</td></tr>";
}
//echo $text;
?>
	</table>
