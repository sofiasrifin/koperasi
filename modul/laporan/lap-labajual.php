...
$pdf->text(10,36,'LAPORAN LABA PENJUALAN');
...
$ya = $yi + $row;
$sql = mysql_query("SELECT h_jual.kodejual,tgljual, d_jual.kode_barang,nama_barang,jmljual,hargajual,
					(jmljual*hargajual) as totaljual, (jmljual*harga_beli) as totalbeli,
